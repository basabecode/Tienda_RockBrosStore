  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img 
          src={heroBanner} 
          alt="Modern electronics including laptops, smartphones and tablets"
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed opacity-90 animate-slide-up">
            Discover cutting-edge technology that powers your digital lifestyle. From premium laptops to smart home devices, we bring you the future today.
          </p>
